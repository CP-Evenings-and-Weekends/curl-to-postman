I used the following script: curl -H 'Accept: application/json' -X GET https://dogapi.dog/api/v2/breeds/ | jq '[.data[] | {name: .attributes.name, description: .attributes.description}]' > README.md
[
  {
 ...
 I used 'sed -i 1i sometext <filename>' to place script in beggining and echo 'some text' >> filename to place this note
